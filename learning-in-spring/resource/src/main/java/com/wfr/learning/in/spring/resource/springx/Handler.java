 ...
 */
package com.wfr.learning.in.spring.resource.springx;
...
public class Handler extends sun.net.www.protocol.x.Handler {
    ...
    // -Djava.protocol.handler.pkgs=com.wfr.learning.resource
    public static void main(String[] args) throws IOException {
        // springx 协议
        // x:///META-INF/production.properties 、 springx:/META-INF/production.properties 、 x:/META-INF/production.properties 都可以
